...
export function Testimonials() {
  return (
    <section
      className="bg-slate-50 border-t border-slate-200 py-20 px-4"
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, i) => (
            <Reveal key={t.name} delay={i * 0.12} className="h-full">
              <figure className="h-full bg-white p-7 ring-2 ring-slate-200 hover:ring-yellow-400 hover:-translate-y-1.5 hover:shadow-[10px_10px_0_0_#141414] transition-all duration-300 flex flex-col gap-5">
